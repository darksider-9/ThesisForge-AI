...
\\usepackage{xeCJK}           % 中文支持 (需使用 XeLaTeX 编译)
...
% --------------------------------------------------------
% Fonts Setup (System Fonts - Make sure you have these)
% --------------------------------------------------------
% Windows: SimSun(宋体), SimHei(黑体), FangSong(仿宋), KaiTi(楷体)
% Overleaf: FandolSong, FandolHei, etc. (Default for xeCJK usually works)
...
export const downloadLatexZip = async (
  ...
  zip.file("README.txt", "Generated by ThesisForge AI.\n\nInstructions:\n1. Upload 'main.tex' to Overleaf.com or compile locally.\n2. Use XeLaTeX compiler (required for Chinese characters).\n3. Ensure you have the necessary fonts (SimSun, SimHei) installed if compiling locally.");
